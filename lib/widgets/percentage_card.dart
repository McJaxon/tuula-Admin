...
class PercentageCard extends StatelessWidget {
  ...
  final dynamic dashController, index;
          ...
          child: Stack(
            children: [
              Positioned(
                  ...
                  left: 20.0,
                  child: Text(
                    dashController['loan_stats']['percentages'][index]
                        ['category'],
                    style: TextStyle(
                        fontFamily: 'Poppins',
            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: const Color.fromARGB(255, 160, 212, 215),
                ),
              ),
              SizedBox(
                width: 4.w,
