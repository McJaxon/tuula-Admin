...
//         );
//         await ios.FlutterNfcKit.setIosAlertMessage(
//             "One moment please, i am doing some stuff");
...
//   Future<void> _writeNDEFRecord() async {
//     if (isIos) {
...
//             payload:
//                 Uint8List.fromList('vnd.com.yourdomain.appname'.codeUnits)),
//       ]);
...
//       ]);
//       final resultWriting = NFC.writeNDEF(newMessage).handleError((e, _) {
