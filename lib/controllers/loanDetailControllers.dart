...
// import 'package:admin_banja/screens/success_screen.dart';
...
//     } else {
//       try {
//          Server.syncLoanApplication(loanApplicationModel).then((value) {
//           LocalDB.writeLoanApplicationDetails(loanApplicationModel.toMap())
//               .then((value) {
//             Navigator.pushReplacement(
//                 context,
//                 MaterialPageRoute(
//                     builder: ((context) =>
//                         SuccessScreen(loanDetails: loanApplicationModel))));
//           });
//         });
//       } catch (e) {
//         print(e);
