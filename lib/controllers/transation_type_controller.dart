...
class TransactionTypeController extends GetxController {
  ...
  confirmTransactionTypeDelete(BuildContext context, var categoryID) {
    refreshState(false);
    showDialog(
        context: context,
        builder: (context) {
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'You are deleting this transaction type and this action is not reversible, this information will not be available for other users. Confirm action to delete',
                      style:
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: GestureDetector(
                            onTap: () {
                              Server().deleteTransactionType(categoryID);
                              Navigator.pop(context);
                              refreshState(true);
                            },
                            child: Container(
  ...
  showEditTransactionTypeSheet(BuildContext context, var data) {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Text(
                          'This section lets you edit a transaction type',
                          style:
                              ...
                              child: Padding(
                                ...
                                child: ListView(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                            hintText:
                                                'Describe name of loan eg Mobile Money',
                                            hintStyle:
                                    ...
                                    Text(
                                      'Briefly describe the type of transaction?',
                                      style: TextStyle(
                                          fontFamily: 'Poppins',
                                          fontSize: 16.8.sp),
                                    ),
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              if (name.value.text.isEmpty ||
                                ...
                                Server.updateTransactionType(
                                    transactionTypeData, data['id']);
                                refreshState(true);
                              }
                            },
                            child: Container(
  ...
  showCreateTransactionTypeSheet(BuildContext context) {
    HapticFeedback.lightImpact();
    return showModalBottomSheet(
        enableDrag: false,
        isScrollControlled: true,
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Text(
                          'This section lets you add a Transaction Type',
                          style:
                              TextStyle(fontFamily: 'Poppins', fontSize: 17.sp),
                        ),
                        Padding(
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              if (_name.value.text.isEmpty ||
                                  _description.value.text.isEmpty) {
                                CustomOverlay.showToast(
                                    'Fill all fields to continue saving',
                                    Colors.red,
                                    Colors.white);
